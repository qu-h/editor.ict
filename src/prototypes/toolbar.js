...
export const showToolbar = function (callback) {
...
export const hideToolbar = function (callback) {
    var settings = this.settings;
...
export const setToolbarAutoFixed = function (fixed) {
...
export const getToolbarHandles = function (name) {
    const editormd = this
...
export const setToolbarHandler = function () {
    var _this               = this
    const editormd = this
    var settings            = this.settings
    ...
    toolbarIcons.bind(editormd.mouseOrTouch("click", "touchend"), function (event) {
        confirm.log(`===bind MouseTouch`, this)
