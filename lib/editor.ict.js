...
(function (global, factory) {
    ...
    var EditorLoader = /*#__PURE__*/function () {
      ...
      _proto.loadQueues = function loadQueues() {
        ...
        if (settings.previewCodeHighlight) {
          editormd.loadScript(loadPath + "prettify.min").then(function () {
    ...
    var EditorInitial = /*#__PURE__*/function () {
      ...
      _proto.initEditor = function initEditor(id) {
        ...
        editor.classList.add(SettingDefault_1 + "vertical");

        if (settings.theme !== "") {
          editor.classList.add(SettingDefault_1 + "theme-" + settings.theme);
        }
      ...
      _proto.initButtonClose = function initButtonClose() {
        ...
        if (!settings.readOnly) {
          ...
          closeBtn.classList.add("fa", "fa-close", SettingDefault_1 + "preview-close-btn");
      ...
      _proto.initPreview = function initPreview() {
        ...
        this.previewContainer.classList.add("markdown-body", SettingDefault_1 + "preview-container");
        this.preview = document.createElement("div");
        this.preview.classList.add(SettingDefault_1 + "preview");
        this.preview.appendChild(this.previewContainer);
        this.editor.appendChild(this.preview);

        if (settings.previewTheme !== "") {
          this.preview.classList.add(SettingDefault_1 + "preview-theme-" + settings.previewTheme);
        }
      };

      _proto.initSaveHtml = function initSaveHtml() {
        var saveHTMLToTextarea = this.settings.saveHTMLToTextarea;
      ...
      _proto.initMarkdownTextarea = function initMarkdownTextarea() {
        var editor = this.editor,
            settings = this.settings,
            id = this.id; // var markdownTextarea = this.markdownTextarea = editor.children("textarea");
      ...
      _proto.initMask = function initMask() {
        ...
        this.containerMask.classList.add(SettingDefault_1 + "container-mask");
        editor.appendChild(this.containerMask);
        this.mask = document.createElement("div");
        this.mask.classList.add(SettingDefault_1 + "mask"); // this.mask.style.display = 'block'
    ...
    var EditorMD = /*#__PURE__*/function () {
      ...
      _proto.initValue = function initValue() {
        ...
        this.mouseOrTouch = mouseOrTouch; // this.loadedDisplay = editorLoader.loadedDisplay
      ...
      _proto.init = function init(id, options) {
        ...
        var settings = $.extend(true, {}, SettingDefault_3, options);
