...
(function (global, factory) {
    ...
    function bindScrollEvent() {
      ...
      var cmBindScroll = function cmBindScroll() {
        codeMirror.find(".CodeMirror-scroll").bind(mouseOrTouch("scroll", "touchmove"), function (event) {
          ...
          runProxy(settings.onscroll, _this)(event); // $.proxy(settings.onscroll, _this)(event);
        });
      };
    ...
    var EditorInitial = /*#__PURE__*/function () {
      ...
      _proto.initMask = function initMask() {
        ...
        this.mask.classList.add(SettingDefault_1 + "mask");
    ...
    var EditorMD = /*#__PURE__*/function () {
      ...
      _proto.doCloneMethod = function doCloneMethod(object) {
        var classScope = this; // Get the prototype of your class. This will create an object that has one key for every method in your class. I'm not sure if this will go up the prototype chain if you have subclasses. Someone ought to edit this answer to clarify that.
