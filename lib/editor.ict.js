...
(function (global, factory) {
    ...
    var EditorMD = /*#__PURE__*/function () {
      ...
      _proto.init = function init(id, options) {
        ...
        editor.style.height = typeof settings.height === "number" ? settings.height + "px" : settings.height; // editor.css({
        //     width  : (typeof settings.width  === "number") ? settings.width  + "px" : settings.width,
        //     height : (typeof settings.height === "number") ? settings.height + "px" : settings.height
        // });

        if (settings.autoHeight) {
          editor.style.height = "auto"; // editor.css("height", "auto");
        ...
        this.setSaveHtml();
        this.setPreview();
        editor.classList.add(SettingDefault_1 + "vertical"); // editor.append(appendElements)
        //     .addClass(classPrefix + "vertical");

        if (settings.theme !== "") {
          editor.classList.add(SettingDefault_1 + "theme-" + settings.theme); // editor.addClass(classPrefix + "theme-" + settings.theme);
        ...
        this.mask = editor.getElementsByClassName(SettingDefault_1 + "mask");
        this.containerMask = editor.getElementsByClassName(SettingDefault_1 + "container-mask");
        this.htmlTextarea = editor.getElementsByClassName(this.classNames.textarea.html);
        console.log("===markdownTextarea length:" + this.preview.length, {
      ...
      _proto.setPreview = function setPreview() {
      ...
      _proto.setSaveHtml = function setSaveHtml() {
        if (this.settings.saveHTMLToTextarea) {
          var htmlSaving = document.createElement("textarea");
