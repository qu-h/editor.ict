...
(function (global, factory) {
    ...
    var EditorMdObject = /*#__PURE__*/function () {
      function EditorMdObject(id, options) {
        this.initValue();
        this.init(id, options);
      }

      var _proto = EditorMdObject.prototype;
    ...
    function editormd$1(id, options) {
      var test = new EditorMdObject(id, options);
      console.log("=======", {
        test: test
      });
      return test;
