...
(function (global, factory) {
    ...
    function markedRenderer(markdownToC, options) {
      ...
      markedRenderer.heading = function (text, level) {
        ...
        var header = headingRenderder.execute(text, level);
    ...
    var EditorKeyMap = /*#__PURE__*/function () {
      ...
      _proto.registerKeyMaps = function registerKeyMaps(keyMap) {
        ...
        keyMap = keyMap || null;
        console.log("resigKeys", {
          disabledKeyMaps: disabledKeyMaps,
          keyMap: keyMap,
          keyMaps: keyMaps,
          editormd: editormd
        });
